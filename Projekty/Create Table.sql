...
CREATE TABLE IF NOT EXISTS `arch_uprawnione` (
  ...
  `Data_W` datetime NOT NULL,
  `Pokrew` varchar(45) DEFAULT NULL,
  `WPISAL` varchar(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kom_odbiorcy` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=557 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `paczki` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Index_IDO` (`IDO`)
) ENGINE=InnoDB AUTO_INCREMENT=41050 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `prosby` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Index_IDO` (`IDO`)
) ENGINE=InnoDB AUTO_INCREMENT=39127 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `rej_prosb` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=41359 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `synchro` (
  ...
  `Opis` text,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=11541 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `uprawnienia` (
  ...
  `Dzial` enum('Penit','Ochrona','Zatrudnienie','BHP') DEFAULT NULL COMMENT 'Penit, Ochrona, Zatrudnienie',
...
CREATE TABLE IF NOT EXISTS `uprawnione` (
  ...
  KEY `Index_IDO` (`IDO`)
) ENGINE=InnoDB AUTO_INCREMENT=23885 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `widzenia` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Index_IDO` (`IDO`)
) ENGINE=InnoDB AUTO_INCREMENT=47353 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `wnioski` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Index_IDO` (`IDO`)
) ENGINE=InnoDB AUTO_INCREMENT=7705 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `wykaz_bledow` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13051 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `zat_stanowiska` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COMMENT='Zatrudnienie';
...
CREATE TABLE IF NOT EXISTS `zat_zatrudnieni` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=673 DEFAULT CHARSET=utf8 COMMENT='Zatrudnienie';
