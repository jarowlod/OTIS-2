object Rozmieszczenie: TRozmieszczenie
  ...
  object Panel1: TPanel
    ...
    object btnDrukujWykazCel: TBitBtn
      Left = 8
      Height = 30
      Top = 480
      Width = 144
      ...
      OnClick = btnDrukujWykazCelClick
      TabOrder = 5
    end
    object btnDrukujOsadzonych: TBitBtn
      Left = 8
      Height = 30
      Top = 520
      Width = 144
      Caption = 'Drukuj osadzonych'
      Glyph.Data = {
        36040000424D3604000000000000360000002800000010000000100000000100
        2000000000000004000064000000640000000000000000000000000000000000
        00000000000000000000D7C39BFFECE3D6FFECE3D6FFECE3D6FFECE3D6FFECE3
      ...
      OnClick = btnDrukujOsadzonychClick
      TabOrder = 6
    end
  end
  ...
  object ZQRozmieszczenie: TZQuery
    ...
    BeforePost = ZQRozmieszczenieBeforePost
