object NieZatrudnieni: TNieZatrudnieni
  ...
  object Panel5: TPanel
    ...
    object Label1: TLabel
      ...
      Top = 16
      Width = 606
      Caption = 'Statystyka osadzonych niezatrudnionych wraz z powodami braku zatrudnienia.'
  ...
  object ZQBezrobotni: TZQuery
    ...
    SQL.Strings = (
      ...
      'typ.Wychowawca,'
      'inf.Autoryzacja, '
      'inf.data_autoryzacji'
      'FROM osadzeni as os'
      '  LEFT JOIN os_info as inf ON inf.IDO = os.IDO'
      '  LEFT JOIN typ_cel as typ ON typ.POC = os.POC'
      'WHERE '
      '  os.IDO not in (SELECT IDO FROM zat_zatrudnieni WHERE status_zatrudnienia = ''zatrudniony'') '
      '  AND (os.POC <> ''ubył'')'
    )
    Params = <>
    Left = 96
